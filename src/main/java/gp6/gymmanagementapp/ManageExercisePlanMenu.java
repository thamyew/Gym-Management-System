...
public class ManageExercisePlanMenu extends javax.swing.JFrame 
{
    ...
    // Variable used to store the current selected trainer in the selected exercise plan
    private Trainer selectedTrainer;
    
    /**
     * Creates new form AdminManageExercisePlanMenu
     */
    public ManageExercisePlanMenu() 
    {
        initComponents();
    ...
    private void updateTableRow()
    {
        ...
        // Enhanced for-loop to loop the sorted exercise plan list
        for (ExercisePlan exercisePlan : GymManagementApp.exercisePlanList) 
        {
            // Storing related data which are exercise plan ID, description and trainer name
    ...
    // Function used to update the content in the list/table of trainer to be selected by user
    // Is used when:
    // 1) the menu is first initialized
    private void updateTrainerList()
    {
        ...
        // Variables used to store the data to be contained in the list/table which has 3 columns: trainer ID, name and phone number
        Object[] rowData = new Object[3];
    ...
    {
        // Check there is changes on the plan ID of the selected exercise plan before and after
        if (selectedExercisePlan.getPlanID() != Integer.valueOf(planIDField.getText()))
            return true;
    ...
    {
        // Check if the field of exercise plan ID is filled
    ...
    // Is used when:
    // 1) modifying data
    // 2) adding new xercise plan
    private boolean checkDataIsNumber()
    {
        // Checking whether the input for planID input field is number
        if (!GymManagementApp.checkIsNumeric(planIDField.getText()))
            return true;
    ...
    private void displayNewExercisePlanForm()
    {
        ...
        // Set the selectedExercisePlan to null as no exercise plan currently selected
        selectedExercisePlan = null;
        // Set the selectedEquipment to null as new exercise plan does not have an equipment yet
        selectedEquipment = null;
        // Set the selectedTrainer to null as new exercise plan does not have a trainer yet
    ...
    private void displaySelectedExercisePlanDetail()
    {
        ...
        // Update the object of selectedTrainer based on the trainer data stored in the exercise plan
        selectedTrainer = selectedExercisePlan.getTrainer();
    ...
    // This function is used to enable all the input fields / text fields related to trainer when adding new exercise plan
    // Is used when:
    // 1) adding new exercise plan
    private void enableTrainerSection()
    {
        selectTrainerButton.setEnabled(true);
    }
    
    // This function is used to disable all the input fields / text fields related to trainer to prevent users from modifying the data
    // Is used when:
    // 1) include in disableAllTextFields()
    private void disableTrainerSection()
    {
        selectTrainerButton.setEnabled(false);
    }
    ...
    private boolean updateAvailableEquipmentList()
    {
        ...
        if (!availableEquipment.isEmpty())
        {
            ...
            // Variables used to store the data to be contained in the list/table which has 2 columns: equipment ID and equipment name
    ...
    // Is used when:
    // 1) select exercise plan from the table (update the trainer details based on the information stored in the exercise plan)
    // 2) adding new exercise plan (whenever choosing different trainer from the select trainer window)
    private void updateTrainerFields()
    {
        ...
        trainerNameField.setText(selectedTrainer.getFirstName() + " " + selectedTrainer.getLastName());
        // Update the trainerPhoneField based on the selectedTrainer's information
        trainerPhoneField.setText(selectedTrainer.getPhone());
        // Update the trainerEmailField based on the selectedTrainer's information
        trainerEmailField.setText(selectedTrainer.getEmail());
    }
    ...
    private void updatejButton1(int mode)
    {
        ...
        switch(mode)
        {
                ...
                jButton1.addActionListener((ActionEvent e) -> 
                {
                    ...
                    else if (checkDataChanged())
                    {
                        ...
                        if (answer == JOptionPane.YES_OPTION)
                        {
                            ...
                            // Assign the variable selectedExercisePlan, selectedTrainer and selectedEquipment to null as the action performed to change the data of current selected exercise plan is complete
                            selectedExercisePlan = null;
                            selectedTrainer = null;
                            selectedEquipment = null;
            ...
            case 3 -> 
            {
                ...
                enableEquipmentSection();
                // Enable trainer fields to allow users to select the trainer
                enableTrainerSection();
                ...
                jButton1.addActionListener((ActionEvent e) -> 
                {
                    ...
                    else
                    {
                        ...
                        if (answer == JOptionPane.YES_OPTION)
                        {
                            ...
                            GymManagementApp.exercisePlanList.add(new ExercisePlan(Integer.valueOf(planIDField.getText()), selectedTrainer, selectedEquipment, 
    ...
    // There exists 3 functions/modes of the button:
    // 1) Button used to trigger action allows users to delete the data of the selected exercise plan
    // 2) Button used to cancel the process of modifying data of the selected exercise plan (void the process)
    // 3) Button used to cancel the process of adding new exercise plan into the system (void the process)
    ...
    private void updatejButton2(int mode)
    {
        ...
        switch(mode)
        {
            ...
            case 1 ->
            {
                ...
                {
                    // A popup window will be generated and notify the users to confirm they want to delete the selected exercise plan from the system
                    // The users can select "Yes" to confirm the delete selected exercise plan function; "No" and close the window to void the delete selected exercise plan action
                    // Variable used to store the option picked by users
                    int answer = JOptionPane.showConfirmDialog(this, "Are you sure you want to delete the exercise plan from the system?\n(WARNING: This might also delete subscriptions related to the exercise plan)", "Confirm", JOptionPane.YES_NO_OPTION, JOptionPane.QUESTION_MESSAGE);
                    ...
                    if (answer == JOptionPane.YES_OPTION)
                    {
                        ...
                        for (ExercisePlan exercisePlan : GymManagementApp.exercisePlanList) 
                        {
                            ...
                            if (exercisePlan.getPlanID() == selectedExercisePlan.getPlanID())
                            {
                                ...
                                // Remove all subscriptions related to the deleted exercise plan 
                                GymManagementApp.deleteAllRelatedSubscription(exercisePlan);
            ...
            case 3 ->
            {
                ...
                jButton2.addActionListener((ActionEvent e) -> 
                {
                    // A popup window will be generated and notify the users to confirm they want to cancel the adding new exercise plan process
                    // The users can select "Yes" to confirm to cancel the process; "No" and close the window to return users back to adding new exercise plan process
                    // Variable used to store the option picked by users
                    int answer = JOptionPane.showConfirmDialog(this, "Are you sure you want to discard the changes?", "Confirm", JOptionPane.YES_NO_OPTION, JOptionPane.QUESTION_MESSAGE);
                    ...
                    if (answer == JOptionPane.YES_OPTION)
                    {
                        // Update the jButton2's pair, jButton1's function (The function pair (jButton1 / jButton2) is: Modify / Delete)
                        updatejButton1(1);
                        // Update the data in the exercise plan list/table to get the most current exercise plan list and hide the exercise plan detail panel
                        updateTableRow();
                    }
                });
            }
    ...
    private void initComponents() {
        ...
        selectTrainerWindow = new javax.swing.JFrame();
        selectTrainerPanel = new javax.swing.JPanel();
        ...
        trainerSelectButton = new javax.swing.JButton();
        trainerCancelButton = new javax.swing.JButton();
        ...
        selectTrainerButton = new javax.swing.JButton();
        ...
        if (equipmentTable.getColumnModel().getColumnCount() > 0) {
            ...
            equipmentTable.getColumnModel().getColumn(0).setPreferredWidth(15);
            equipmentTable.getColumnModel().getColumn(1).setResizable(false);
            equipmentTable.getColumnModel().getColumn(1).setPreferredWidth(130);
        }
        ...
        selectTrainerWindow.setDefaultCloseOperation(javax.swing.WindowConstants.DO_NOTHING_ON_CLOSE);
        selectTrainerWindow.setTitle("Select Trainer");
        selectTrainerWindow.setLocation(new java.awt.Point(550, 200));
        selectTrainerWindow.setMinimumSize(new java.awt.Dimension(400, 440));
        selectTrainerWindow.setResizable(false);
        ...
        if (trainerTable.getColumnModel().getColumnCount() > 0) {
            ...
            trainerTable.getColumnModel().getColumn(0).setPreferredWidth(15);
            trainerTable.getColumnModel().getColumn(1).setResizable(false);
            trainerTable.getColumnModel().getColumn(1).setPreferredWidth(130);
            trainerTable.getColumnModel().getColumn(2).setResizable(false);
            trainerTable.getColumnModel().getColumn(2).setPreferredWidth(100);
        }

        trainerListLabel.setFont(new java.awt.Font("MS UI Gothic", 0, 24)); // NOI18N
        trainerListLabel.setText("<html><u>Trainer List</u>");

        trainerSelectButton.setFont(new java.awt.Font("Segoe UI", 0, 18)); // NOI18N
        trainerSelectButton.setText("Select");
        trainerSelectButton.setCursor(new java.awt.Cursor(java.awt.Cursor.HAND_CURSOR));
        trainerSelectButton.addMouseListener(new java.awt.event.MouseAdapter() {
            public void mouseClicked(java.awt.event.MouseEvent evt) {
                trainerSelectButtonMouseClicked(evt);
            }
        });

        trainerCancelButton.setFont(new java.awt.Font("Segoe UI", 0, 18)); // NOI18N
        trainerCancelButton.setText("Cancel");
        trainerCancelButton.setCursor(new java.awt.Cursor(java.awt.Cursor.HAND_CURSOR));
        trainerCancelButton.addMouseListener(new java.awt.event.MouseAdapter() {
            public void mouseClicked(java.awt.event.MouseEvent evt) {
                trainerCancelButtonMouseClicked(evt);
            }
        });

        javax.swing.GroupLayout selectTrainerPanelLayout = new javax.swing.GroupLayout(selectTrainerPanel);
        selectTrainerPanel.setLayout(selectTrainerPanelLayout);
        selectTrainerPanelLayout.setHorizontalGroup(
            selectTrainerPanelLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
            .addGroup(selectTrainerPanelLayout.createSequentialGroup()
                .addGap(23, 23, 23)
                .addComponent(trainerSelectButton)
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
                .addComponent(trainerCancelButton)
                .addGap(23, 23, 23))
            .addGroup(selectTrainerPanelLayout.createSequentialGroup()
                .addGroup(selectTrainerPanelLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(selectTrainerPanelLayout.createSequentialGroup()
                        .addContainerGap()
                        .addComponent(trainerTableScrollPane, javax.swing.GroupLayout.PREFERRED_SIZE, 342, javax.swing.GroupLayout.PREFERRED_SIZE))
                    .addGroup(selectTrainerPanelLayout.createSequentialGroup()
                        .addGap(120, 120, 120)
                        .addComponent(trainerListLabel, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE)))
                .addContainerGap(javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE))
        );
        selectTrainerPanelLayout.setVerticalGroup(
            selectTrainerPanelLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
            .addGroup(selectTrainerPanelLayout.createSequentialGroup()
                .addContainerGap()
                .addComponent(trainerListLabel, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE)
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                .addComponent(trainerTableScrollPane, javax.swing.GroupLayout.DEFAULT_SIZE, 302, Short.MAX_VALUE)
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                .addGroup(selectTrainerPanelLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                    .addComponent(trainerSelectButton)
                    .addComponent(trainerCancelButton))
                .addContainerGap())
        );

        javax.swing.GroupLayout selectTrainerWindowLayout = new javax.swing.GroupLayout(selectTrainerWindow.getContentPane());
        selectTrainerWindow.getContentPane().setLayout(selectTrainerWindowLayout);
        selectTrainerWindowLayout.setHorizontalGroup(
            selectTrainerWindowLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
            .addGap(0, 354, Short.MAX_VALUE)
            .addGroup(selectTrainerWindowLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                .addGroup(selectTrainerWindowLayout.createSequentialGroup()
                    .addGap(0, 0, Short.MAX_VALUE)
                    .addComponent(selectTrainerPanel, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE)
                    .addGap(0, 0, Short.MAX_VALUE)))
        );
        selectTrainerWindowLayout.setVerticalGroup(
            selectTrainerWindowLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
            .addGap(0, 382, Short.MAX_VALUE)
            .addGroup(selectTrainerWindowLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                .addGroup(selectTrainerWindowLayout.createSequentialGroup()
        ...
        selectTrainerButton.setText("Select Trainer");
        selectTrainerButton.setCursor(new java.awt.Cursor(java.awt.Cursor.HAND_CURSOR));
        selectTrainerButton.addMouseListener(new java.awt.event.MouseAdapter() {
            public void mouseClicked(java.awt.event.MouseEvent evt) {
                selectTrainerButtonMouseClicked(evt);
            }
        });
        ...
        startMinuteSelection.setModel(new javax.swing.SpinnerNumberModel(0, 0, 59, 5));
        ...
        endMinuteSelection.setModel(new javax.swing.SpinnerNumberModel(0, 0, 59, 5));
                ...
                .addGroup(exercisePlanDetailFormPanelLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(exercisePlanDetailFormPanelLayout.createSequentialGroup()
                        .addGroup(exercisePlanDetailFormPanelLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            ...
                            .addGroup(exercisePlanDetailFormPanelLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING)
                                .addComponent(selectTrainerButton, javax.swing.GroupLayout.PREFERRED_SIZE, 156, javax.swing.GroupLayout.PREFERRED_SIZE)
        ...
        exercisePlanDetailFormPanelLayout.setVerticalGroup(
            ...
            .addGroup(exercisePlanDetailFormPanelLayout.createSequentialGroup()
                ...
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                .addComponent(selectTrainerButton, javax.swing.GroupLayout.PREFERRED_SIZE, 20, javax.swing.GroupLayout.PREFERRED_SIZE)
                .addContainerGap())
        );
        ...
        exercisePlanTable.getAccessibleContext().setAccessibleDescription("");
    ...
    // This function is called whenever the user click on the content in the exercise plan list/table
    // This function is used to display the selected exercise plan detail when the user select a row of data in the table/list
    private void exercisePlanTableMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_exercisePlanTableMouseClicked
        ...
        {
            // Display the selected exercise plan detail by using displaySelectedExercisePlanDetail() function
            displaySelectedExercisePlanDetail();
    ...
    // This function is called whenever the user click on the add exercise plan button
    // This function is used to display a new form for user to input data for the new exercise plan that is going to be added into the system
    ...
    // This function is used to close the manage exercise plan window and return user to the menu
    private void returnButtonMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_returnButtonMouseClicked
        // Check if is staff or admin using the system, if loggedInStaff is not null, means is the staff is using the system
        if (StaffMainMenu.loggedInStaff != null)
            new StaffMainMenu();
        else 
            new AdminMainMenu();
        // Dispose the window when the return to menu button is clicked (**This action will close the manage exercise plan window)
        this.dispose();
    }//GEN-LAST:event_returnButtonMouseClicked
    
    // This function is called whenever the select equipment button is clicked
    // This function is used to open the select equipment window for user to select equipment used for the exercise plan if at least on exercise day has been chosen
    // This function will prompt an error message to user to notify user to select at least one exercise day if no exercise day selected when clicked on this button
    ...
    // This function is called whenever the durationSelection field has value changed
    // This function is used to update the estimated end time based on the expected duration and start time inputted
    // This function will also deselect the selectedEquipment
    ...
    // This function is called whenever the startHourSelection field has value changed
    // This function is used to update the estimated end time based on the expected duration and start time inputted
    // This function will also deselect the selectedEquipment
    ...
    // This function is called whenever the startMinuteSelection field has value changed
    // This function is used to update the estimated end time based on the expected duration and start time inputted
    // This function will also deselect the selectedEquipment
    ...
    // This function is called when the select equipment button in the select equipment window is clicked
    // This function is used to update selectedEquipment based on the selection by user on the select equipment table
    ...
    private void trainerSelectButtonMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_trainerSelectButtonMouseClicked
        // Variable used to store the row number of the data row selected from the list/table
        ...
        if (rowSelected >= 0)
        {
            ...
            // Assign the selectedTrainer with trainer with same trainer ID with selectedTrainerID
            selectedTrainer = GymManagementApp.getTrainer(selectedTrainerID);
            
            // Dispose the select trainer window
            selectTrainerWindow.dispose();
            
            // Enabled and focus on the main window
            this.setEnabled(true);
            this.requestFocus();

            // Update the trainer fields with the selected trainer information
            updateTrainerFields();
        }
        else
            // If there is no item selected, a popup window will be generated and notify the users to select an item from the list
            // The users can select either "Yes" or "Cancel" or close the window as three options will lead to same result which is allowing users to return to select at least one item from the list
            JOptionPane.showConfirmDialog(this, "Please select an equipment from the list!", "Error Message", JOptionPane.OK_CANCEL_OPTION, JOptionPane.ERROR_MESSAGE);
    }//GEN-LAST:event_trainerSelectButtonMouseClicked
    ...
    private void trainerCancelButtonMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_trainerCancelButtonMouseClicked
        // Dispose the select trainer window
        selectTrainerWindow.dispose();
        // Enabled and focus on the main window
        this.setEnabled(true);
        this.requestFocus();
    }//GEN-LAST:event_trainerCancelButtonMouseClicked

    // This function is called when the select trainer button is clicked
    // This function is used to call the select trainer window
    private void selectTrainerButtonMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_selectTrainerButtonMouseClicked
        // Check if select trainer button is enabled
        if (selectTrainerButton.isEnabled())
        {
            // Check if trainer list is empty or not
            if (!GymManagementApp.trainerList.isEmpty())
            {
                // If the list is not empty
                // Make the select trainer window visible
                selectTrainerWindow.setVisible(true);
            ...
            {
                // If there is no trainer in the list, a popup window will be generated and notify the users to add trainer first before using this option
                // The users can select either "Yes" or "Cancel" or close the window as three options will lead to same result which is allowing users to return to modify exercise plan detail
                JOptionPane.showConfirmDialog(this, "There is no trainer in the list! Please add trainer into the system first!", "Error Message", JOptionPane.OK_CANCEL_OPTION, JOptionPane.ERROR_MESSAGE);
            }
        }
    }//GEN-LAST:event_selectTrainerButtonMouseClicked
    
    // This function is called whenever the sundayCheck field is seleceted or deselected
    // This function is used to deselect the equipment as equipment selected previously might not be available in another day
    ...
    // This function is called whenever the mondayCheck field is seleceted or deselected
    // This function is used to deselect the equipment as equipment selected previously might not be available in another day
    ...
    // This function is called whenever the tuesdayCheck field is selected or deselected
    // This function is used to deselect the equipment as equipment selected previously might not be available in another day
    ...
    // This function is called whenever the wednesdayCheck field is selected or deselected
    // This function is used to deselect the equipment as equipment selected previously might not be available in another day
    ...
    // This function is called whenever the thursdayCheck field is selected or deselected
    // This function is used to deselect the equipment as equipment selected previously might not be available in another day
    ...
    // This function is called whenever the fridayCheck field is selected or deselected
    // This function is used to deselect the equipment as equipment selected previously might not be available in another day
    ...
    // This function is called whenever the saturdayCheck field is selected or deselected
    // This function is used to deselect the equipment as equipment selected previously might not be available in another day
    ...
    private javax.swing.JButton selectTrainerButton;
    private javax.swing.JPanel selectTrainerPanel;
    private javax.swing.JFrame selectTrainerWindow;
    ...
    private javax.swing.JButton trainerCancelButton;
    ...
    private javax.swing.JButton trainerSelectButton;
